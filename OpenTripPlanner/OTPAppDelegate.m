...
//    RKLogConfigureByName("RestKit/ObjectMapping", RKLogLevelTrace);
    ...
    // Initialize RestKit
    // NSString* u = @"http://demo.opentripplanner.org/opentripplanner-api-webapp/ws";
    NSString* u = @"http://geo.gatech.edu/opentripplanner-api-webapp/ws";
    // NSString* u = @"http://opentripplanner.usf.edu/opentripplanner-api-webapp/ws";
    RKObjectManager* objectManager = [RKObjectManager managerWithBaseURLString:u];
    ...
    RKObjectMapping* poiMapping = [RKObjectMapping mappingForClass:[PointOfInterest class]];
    [poiMapping mapKeyPathsToAttributes:
     @"name", @"name",
     @"lat", @"latitude",
     @"lng", @"longitude",
     nil];
    
    RKObjectMapping* placeSearchResultMapping = [RKObjectMapping mappingForClass:[PlaceSearchResult class]];
    [placeSearchResultMapping mapKeyPath:@"places" toRelationship:@"places" withMapping:poiMapping];
    ...
    [responseMapping mapKeyPath:@"placeSearchResult" toRelationship:@"placeSearchResult" withMapping:placeSearchResultMapping];
    
    [objectManager.mappingProvider setObjectMapping:responseMapping forResourcePathPattern:@"/plan"];
    [objectManager.mappingProvider setObjectMapping:responseMapping forResourcePathPattern:@"/places/search"];
